...
- [Core Modules](#core-modules)
  - [abs_client.py (~850 lines)](#abs_clientpy-850-lines)
  - [covers.py (~350 lines)](#coverspy-350-lines)
  - [torrent_helpers.py (~220 lines)](#torrent_helperspy-220-lines)
  - [utils.py (~110 lines)](#utilspy-110-lines)
- [Import Workflow](#import-workflow)
- [Verification System Deep Dive](#verification-system-deep-dive)
  - [Scoring Algorithm](#scoring-algorithm)
  - [Retry Logic](#retry-logic)
  - [When Verification Runs](#when-verification-runs)
- [Cover Caching System](#cover-caching-system)
  - [Storage Strategy](#storage-strategy)
  - [Fetch Workflow](#fetch-workflow)
  - [Auto-Cleanup](#auto-cleanup)
  - [Auto-Healing](#auto-healing)
  - [Direct Fetch Mode](#direct-fetch-mode)
...
- [Multi-Disc Flattening](#multi-disc-flattening)
  - [Problem](#problem)
  - [Solution](#solution)
  - [Detection Algorithm](#detection-algorithm)
  - [Extraction Logic](#extraction-logic)
  - [Renaming Algorithm](#renaming-algorithm)
  - [Edge Cases](#edge-cases)
- [Configuration](#configuration)
  - [Environment Variables](#environment-variables)
  - [Path Mapping Critical Notes](#path-mapping-critical-notes)
